    ...
    <div class="bg-blue">
      ...
      >
        ...
        >
          ...
          >
            <NuxtLink data-message="Home" class="p-4 lg:py-5" href="/fr/">
              <div class="">
                <svg
                  width="44"
                  height="25"
        ...
        >
          <div class="flex flex-col items-end lg:flex-row lg:items-start">
            ...
            >
              <div class="mb-6">
                <NuxtLink class=" " to="/fr/" @click="isShowing = !isShowing">
                  <h3
                ...
                <NuxtLink to="/fr/#welcome" @click="isShowing = !isShowing">
                  <p
              ...
              <div class="mb-6 lg:break-after-column">
                ...
                <NuxtLink
                  class=" "
                  to="/fr/tv-co-productions-and-collaborations"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                  >
                    Coproductions et collaborations télévisées
                  </p>
                </NuxtLink>
                ...
                <NuxtLink
                  class=" "
                  to="/fr/diversity-equity-and-inclusion"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
              ...
              <div class="mb-6">
                <NuxtLink
                  class=" "
                  to="/fr/enabling-our-members"
                  @click="isShowing = !isShowing"
                >
                  <h3
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none font-black uppercase text-2xl pb-4 text-orange tracking-wide"
                  >
                    Permettre à nos Membres
                  </h3>
                </NuxtLink>

                <NuxtLink
                  class=" "
                  to="/fr/aidi-initiative"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                ...
                <NuxtLink
                  class=" "
                  to="/fr/media-intelligence-service"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                  >
                    Service d’Analyse Médias
                  </p>
                </NuxtLink>

                <NuxtLink
                  class=" "
                  to="/fr/legal-and-policy"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                ...
                <NuxtLink
                  class=" "
                  to="/fr/international-partnerships"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                ...
                <NuxtLink
                  class=" "
                  to="/fr/relationships-with-the-platforms"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                ...
                <NuxtLink
                  class=" "
                  to="/fr/world-radiocommunication-conference-2023"
                  @click="isShowing = !isShowing"
                >
                  <p
                    class="transition transform ease-in hover:translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none text-white uppercase text-base leading-tight tracking-wider pb-3"
                  >
                    Conférence mondiale des radiocommunications 2023 de l’UIT
                  </p>
                </NuxtLink>
              </div>
